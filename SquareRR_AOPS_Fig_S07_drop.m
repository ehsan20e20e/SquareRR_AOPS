...
%%% finding of Local Maximum of the second-order derivative of drop transmission <===> minimum of drop spectrum
Max_Through2=[]; % Local Maximum of second-order derivative of drop transmission <===> minimum of drop spectrum
pkss2=[]; % peaks of each spectrum in the following loop (not matter)
id_MT2=[]; % id of Local Maximum of the second-order derivative of drop spectrum
...
Max_Through=[Max_Through;pkss]; % concatenating of peaks of each spectrum to achieve Local Maximum of drop spectrum
id_MT=[];
d=[];
...
d1=[];
   ...
   %%% finding of Local Maximum of second-order derivative of drop transmission <===> minimum of drop spectrum ('MinPeakProminence' used for sharp min/max)
...
Max_Through2=[Max_Through2;pkss2]; % concatenating of peaks of each spectrum to achieve Local Maximum of drop spectrum
id_MT2=[];
d2=[];
end
