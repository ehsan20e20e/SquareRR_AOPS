...
%%% finding of Local Maximum of second-order derivative of through transmition <===> minimum of through spectrum
Max_Through2=[]; % Local Maximum of second-order derivative of through transmition <===> minimum of through spectrum
pkss2=[]; % peaks of each spectrum in following loop (not matter)
id_MT2=[]; % id of Local Maximum of second-order derivative of through spectrum
...
Max_Through=[Max_Through;pkss]; % concatinating of peaks of each spectrum to achieve Local Maximum of through spectrum
id_MT=[];
d=[];
...
d1=[];
   ...
   %%% finding of Local Maximum of second-order derivative of through transmition <===> minimum of through spectrum ('MinPeakProminence' used for sharp min/max)
...
Max_Through2=[Max_Through2;pkss2]; % concatinating of peaks of each spectrum to achieve Local Maximum of through spectrum
id_MT2=[];
d2=[];
end
